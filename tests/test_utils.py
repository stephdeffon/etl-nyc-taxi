...
def mock_df():
    return pd.DataFrame({
        "trip_id": [1, 2, 3],
        "pickup_datetime": pd.to_datetime(["2025-01-01 08:00", "2025-01-01 09:00", "2025-01-01 10:00"]),
        "dropoff_datetime": pd.to_datetime(["2025-01-01 08:30", "2025-01-01 09:45", "2025-01-01 10:20"]),
...
def mock_summary(mock_df):
    summary = {
        "nb_rows": len(mock_df),
        "nb_columns": len(mock_df.columns)
    }
    return summary
